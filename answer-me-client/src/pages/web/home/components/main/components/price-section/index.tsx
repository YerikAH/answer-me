            ...
            >
              {frequencies.map((option) => (
                <Radio
                  key={option.value}
                  value={option}
                  className="cursor-pointer rounded-full px-2.5 py-1 text-gray-500 data-[checked]:bg-zinc-900 data-[checked]:text-white"
                >
                  {option.label}
                </Radio>
              ))}
          ...
          {tiers.map((tier) => (
            ...
            >
              ...
              <ul
                role="list"
                className={classNames(
                  tier.featured ? "text-gray-300" : "text-zinc-900",
