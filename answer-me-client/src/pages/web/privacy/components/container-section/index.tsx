    ...
    <div className="bg-white px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base leading-7 text-zinc-700">
        ...
        <div className="mt-10 max-w-2xl">
          ...
          <ul role="list" className="mt-8 max-w-xl space-y-8 text-zinc-600">
            ...
            <li className="flex gap-x-3">
              ...
              />
              <span>
                <strong className="font-semibold text-zinc-900">Loops.</strong>{" "}
            ...
            <li className="flex gap-x-3">
              ...
              />
              <span>
                <strong className="font-semibold text-zinc-900">Events.</strong>{" "}
        ...
        <figure className="mt-16">
          <figcaption className="mt-4 flex gap-x-2 text-sm leading-6 text-zinc-500">
            <InformationCircleIcon
              aria-hidden="true"
              className="mt-0.5 h-5 w-5 flex-none text-zinc-300"
            />
