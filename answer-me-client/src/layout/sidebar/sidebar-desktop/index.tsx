...
export const SidebarDesktop = ({ navigation, codes, links }: Props) => {
  ...
  return (
    <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-60 lg:flex-col">
      <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-zinc-50 ">
        <div className="h-14 shrink-0 items-center flex  px-2 border-b">
          <a className="flex items-center gap-2 bg-zinc-50 w-full p-1 rounded-md hover:bg-zinc-200 cursor-pointer transition-all">
            ...
            <ul className="mt-auto -mx-2">
              ...
              >
                <div className="w-full">
                  <MenuButton className="flex justify-between items-center gap-x-1.5 w-full rounded-md bg-zinc-50 px-2 py-2 text-sm font-semibold text-gray-900  hover:bg-zinc-200">
